  ...
  <div class="calendar">
    <div class="calendar-main" :class="{ 'calendar-main-close': !openSidebar }">
      ...
      <div class="sidebar-open-btn" @click="changeSider">
        <i class="iconfont icon-right" :style="{ transform: openSidebar ? '' : 'rotate(180deg)' }" />
      </div>
    </div>
    <div class="calendar-sidebar-content" :class="{ 'calendar-sidebar-content-close': !openSidebar }">
    ...
    <a class="github-corner" href="https://github.com/lion1ou/calendar" target="_blank" rel="noopener noreferrer"
      title="GitHub">
